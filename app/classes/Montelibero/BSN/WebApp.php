...
class WebApp
{
    ...
    {
        return preg_match('~^/(?:editor(?:[/?#]|$)|accounts/[A-Z0-9]+/edit_tags(?:[/?#]|$)|tools/(?:close_trustlines|create_account|multisig|open_trustlines|orders|payment|swap)(?:[/?#]|$)|(?:mtla/)?crowd(?:[/?#]|$))~', $return_to) === 1;
    }
